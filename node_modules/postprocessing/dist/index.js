/**
 * postprocessing v7.0.0-beta.14 build Sat Sep 13 2025
...
import { EventDispatcher as EventDispatcher12, MathUtils, Uniform as Uniform20, Vector3 as Vector35 } from "three";
var ColorDecisionList = class extends EventDispatcher12 {
  ...
  constructor() {
    ...
    this.uniform = new Uniform20({
      slope: new Vector35(1, 1, 1),
      offset: new Vector35(0, 0, 0),
      power: new Vector35(1, 1, 1),
      saturation: 1
    });
    this._enabled = true;
  }
...
import { Color as Color5, Uniform as Uniform21, Vector2 as Vector28 } from "three";
...
var VignetteEffect = class extends Effect {
  ...
  constructor({
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("offsetFeather", new Uniform21(new Vector28(offset, feather)));
...
import { Uniform as Uniform27, Vector2 as Vector29 } from "three";
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        texelPosition: new Uniform27(new Vector29())
      }
    });
  }
  /**
...
import { Uniform as Uniform30, Vector2 as Vector210 } from "three";
...
var GaussianBlurMaterial = class extends FullscreenMaterial {
  ...
  constructor({ kernelSize = 35 } = {}) {
    super({
      ...
      uniforms: {
        direction: new Uniform30(new Vector210()),
...
import { Uniform as Uniform33, Vector2 as Vector211, Vector4 as Vector44 } from "three";
...
var TiltShiftBlurMaterial = class extends KawaseBlurMaterial {
  ...
  constructor({
    ...
    this.uniforms.rotation = new Uniform33(new Vector211());
    this.uniforms.maskParams = new Uniform33(new Vector44());
    this._offset = offset;
...
var LookupTexture = class _LookupTexture extends Data3DTexture {
  ...
  constructor(data, size) {
    ...
    this.needsUpdate = true;
    this.userData = {
      domainMin: new Vector36(0, 0, 0),
      domainMax: new Vector36(1, 1, 1)
    };
  }
  /**
